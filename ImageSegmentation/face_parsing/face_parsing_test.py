...
def face_parsing_test(input_images, blurring=0, facebox=False, benchmark=False, threshold=0.8, encoder='rtnet50', decoder='fcn', max_num_faces=5, num_classes=11, weights=None, device='cuda:0'):
    '''
    IN
    ...
    --max_num_faces: Max number of faces (default: 5)
