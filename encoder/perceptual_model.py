...
class PerceptualModel:
    ...
    def build_perceptual_model(self, generated_image_tensor):
        ...
        self.ref_img_features = tf.compat.v1.get_variable('ref_img_features', shape=generated_img_features.shape,
                                                dtype='float32', initializer=tf.initializers.zeros())
        self.features_weight = tf.compat.v1.get_variable('features_weight', shape=generated_img_features.shape,
                                               dtype='float32', initializer=tf.initializers.zeros())
